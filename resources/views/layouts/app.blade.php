            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('dashboard') }}"
                        ...
                        <svg class="shrink-0 w-5 h-5 text-white transition duration-100 group-hover:text-gray-900 dark:group-hover:text-white"
                ...
                <li>
                    <a href="{{ route('setup-apps') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Setup Apps</span>
                        {{-- <span
                            class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">-</span> --}}
                    </a>
                </li>
