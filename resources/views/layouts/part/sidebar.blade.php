        ...
        <div>
            <div @click="openMenu === {{ $menu['id'] }} ? openMenu = null : openMenu = {{ $menu['id'] }}"
                ...
                <div class="flex items-center">
                    <!-- Icon -->
                    <svg class="shrink-0 w-5 h-5  hover:text-black" fill="currentColor" viewBox="0 0 18 18">
                        <path
            ...
            <ul x-show="openMenu === {{ $menu['id'] }}" x-collapse class="ml-6 mt-1 space-y-1 overflow-hidden"
                x-cloak>
