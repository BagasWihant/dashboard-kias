<div class="z-20 w-full h-full bg-blue-400/30 backdrop-blur-md absolute left-0 top-0 flex justify-center items-center">
    {{-- <div class="w-full h-full bg-blue-400/30 backdrop-blur-md flex items-center justify-center"> --}}
    <svg version="1.1" class="w-32 h-32 mx-auto text-blue-600"
        id="cog9_1_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="-13 -13 45 45" enable-background="new 0 0 96 96" xml:space="preserve">
        <style>
            .box5631 {
